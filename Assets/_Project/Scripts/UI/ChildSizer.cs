...
namespace FunForLab.UI
{
    public class ChildSizer : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2Int _active;
        ...
        /*[Button] void Update()
    {
        ...
        private void Resize()
        {
            _self.sizeDelta = new Vector2(
                Mathf.Lerp(_self.rect.width , _child.rect.width + _offset.x,  _active.x),
                Mathf.Lerp( _self.rect.height , _child.rect.height + _offset.y, _active.y)
            );
        }
    }
}